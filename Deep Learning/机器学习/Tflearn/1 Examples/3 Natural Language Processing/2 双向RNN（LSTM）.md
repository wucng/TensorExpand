...
参考：[tflearn](https://github.com/tflearn/tflearn/blob/master/examples/nlp/bidirectional_lstm.py)
```python
# -*- coding: utf-8 -*-
"""
...
```
# 2、tensorflow
参考：[TensorFlow-Examples](https://github.com/aymericdamien/TensorFlow-Examples/blob/master/examples/3_NeuralNetworks/bidirectional_rnn.py)
