分类任务，请参阅[tutorial_mnist_simple.py](https://github.com/tensorlayer/tensorlayer/blob/master/example/tutorial_mnist_simple.py)。
...
network=tf.layers.dense(network,10,tf.identity, name='output')
