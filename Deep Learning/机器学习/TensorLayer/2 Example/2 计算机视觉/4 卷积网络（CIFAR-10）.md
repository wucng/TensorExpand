分类任务，请参阅[tutorial_cifar10.py](https://github.com/tensorlayer/tensorlayer/blob/master/example/tutorial_cifar10.py)和[tutorial_cifar10_tfrecord.py](https://github.com/tensorlayer/tensorlayer/blob/master/example/tutorial_cifar10_tfrecord.py)。
