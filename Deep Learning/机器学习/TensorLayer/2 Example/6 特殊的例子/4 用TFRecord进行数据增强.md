 加载和预处理数据的有效方法，请参阅[tutorial_tfrecord * .py](https://github.com/tensorlayer/tensorlayer/tree/master/example)和[tutorial_cifar10_tfrecord.py](https://github.com/tensorlayer/tensorlayer/blob/master/example/tutorial_cifar10_tfrecord.py)
