...
- [Sarsa 简介视频](https://morvanzhou.github.io/tutorials/machine-learning/ML-intro/4-04-sarsa/)
- [Sarsa(lambda) Python 教程](https://morvanzhou.github.io/tutorials/machine-learning/reinforcement-learning/3-3-tabular-sarsa-lambda/)
- [Sarsa Python 教程](https://morvanzhou.github.io/tutorials/machine-learning/reinforcement-learning/3-1-tabular-sarsa1/)
...
# Sarsa(n)
![这里写图片描述](https://morvanzhou.github.io/static/results/ML-intro/sl1.png)
...
# 单步更新 and 回合更新
单步更新Sarsa(0) and 回合更新Sarsa(1)
![这里写图片描述](https://morvanzhou.github.io/static/results/ML-intro/sl2.png)
...
# 有时迷茫
![这里写图片描述](https://morvanzhou.github.io/static/results/ML-intro/sl3.png)
...
# Lambda 含义
![这里写图片描述](https://morvanzhou.github.io/static/results/ML-intro/sl4.png)
...
# Lambda 取值
![这里写图片描述](https://morvanzhou.github.io/static/results/ML-intro/sl5.png)
