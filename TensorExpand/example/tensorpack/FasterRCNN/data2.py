...
def get_train_dataflow():
    ...
    names=cfg.DATA.TRAIN
    imgs=[]
    for name in names:
        imgs_ = cocoDataFlow(
            cfg.DATA.BASEDIR, name, add_gt=True, add_mask=cfg.MODE_MASK)
        imgs.extend(imgs_)
    ...
    def preprocess(img):
        ...
        try:
            ...
            print("Some boxes have zero area!")
...
def get_eval_dataflow():
    ...
    imgs = cocoDataFlow(cfg.DATA.BASEDIR, cfg.DATA.VAL, add_gt=False)
