...
network=tflearn.conv_2d(network,32,3,activation='relu', regularizer="L2") # [-1,19,19,32]
...
network = tflearn.lstm(network, hiddle_layes_2, dropout=dropout_) # 10个[-1,256]序列
