...
branch2=tf.layers.conv2d(net,32,7,1,padding='valid',activation=tf.nn.relu) # [n,26,26,32]
branch2=slim.batch_norm(branch2,is_training=is_training)
branch3=tf.layers.conv2d(net,64,7,1,padding='valid',activation=tf.nn.relu) # [n,26,26,64]
branch3=slim.batch_norm(branch3,is_training=is_training)
branch4=tf.layers.conv2d(net,64,7,1,padding='valid',activation=tf.nn.relu) # [n,26,26,64]
branch4=slim.batch_norm(branch4,is_training=is_training)
branch5=tf.layers.conv2d(net,128,7,1,padding='valid',activation=tf.nn.relu) # [n,26,26,128]
branch5=slim.batch_norm(branch5,is_training=is_training)

net1=tf.concat([branch1, branch2, branch3,branch4,branch5],axis=-1) #[n,26,26,320]
net1=tf.layers.max_pooling2d(net1,2,2,'same') # [n,13,13,320]

branch1=tf.layers.conv2d(net1,512,5,1,padding='valid',activation=tf.nn.relu) # [n,9,9,512]
branch1=slim.batch_norm(branch1,is_training=is_training)
...
branch3=slim.batch_norm(branch3,is_training=is_training)
branch4=tf.layers.conv2d(net1,1024,5,1,padding='valid',activation=tf.nn.relu) # [n,9,9,1024]
branch4=slim.batch_norm(branch4,is_training=is_training)

net2=tf.concat([branch1, branch2, branch3,branch4],axis=-1) #[n,9,9,3072]
net2=tf.layers.max_pooling2d(net2,2,2,'same') # [n,5,5,3072]
...
prediction=slim.dropout(prediction,keep_rate,is_training=is_training)
prediction=slim.softmax(prediction) # [n,3755]
'''
